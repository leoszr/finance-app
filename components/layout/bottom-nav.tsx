...
const navItems = [
  ...
  { href: '/investimentos', label: 'Investimentos', icon: Landmark }
]
...
export function BottomNav() {
  ...
  return (
    <nav aria-label="Navegacao principal" className="fixed bottom-0 left-1/2 z-50 w-full max-w-md -translate-x-1/2 border-t border-slate-200 bg-white/95 px-2 pb-3 pt-2 backdrop-blur">
